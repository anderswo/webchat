#!/usr/bin/env python
# -*- coding: utf-8 -*-
""" Python webchat with websockets using Autobahn running on Twisted
The source code is based on the following tutorial by Paweł Miechl:
...
if __name__ == "__main__":
    ...
    factory = ChatRouletteFactory(u"ws://127.0.0.1:8080", True)  # debug=True
